// lib/screens/profile/settings/privacy_security_page.dart
...
class _PrivacySecurityPageState extends State<PrivacySecurityPage> {
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) => MultiBlocProvider(
        ...
        child: Scaffold(
          ...
          body: Row(
            children: [
              const AppSidebar(selectedItem: SidebarItem.Profile), // ضمن قسم البروفايل
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.lock_person, color: AppColors.purple, size: 26.sp),
                          SizedBox(width: 8.w),
                          Text(
                            AppLocalizations.of(context)?.translate("privacy_security") ?? "Privacy & Security",
                          ...
                          builder: (context, state) {
                            ...
                            return Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Icon(Icons.mark_email_read, color: AppColors.orange),
                                    SizedBox(width: 8.w),
                                    Text(
                                        AppLocalizations.of(context)?.translate("send_verification_code") ?? "Send verification code",
                                ...
                                TextField(
                                  ...
                                  decoration: _input(
                                      AppLocalizations.of(context)?.translate("email_address") ?? "Email address",
                                      ),
                                ),
                                SizedBox(height: 12.h),
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: loading
                                      ...
                                      context
                                          ...
                                          .sendCode(email: _emailCtrl.text.trim());
                                    },
                                    style: _btnStyle(primary: AppColors.purple),
                                    child: loading
                                        ? const SizedBox(
                                        width: 18, height: 18, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
                                        :  Text(
                                        AppLocalizations.of(context)?.translate("send_code") ?? "Send code",
                          ...
                          builder: (context, state) {
                            ...
                            return Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Icon(Icons.password, color: AppColors.purple),
                                    SizedBox(width: 8.w),
                                    Text('Reset password',
                                        style: TextStyle(
                                            fontSize: 16.sp,
                                ...
                                TextField(
                                  ...
                                  decoration: _input('Verification token (from email)'),
                                ),
                                SizedBox(height: 12.h),
                                TextField(
  ...
  BoxDecoration _glassDeco(BuildContext context) => BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(color: Colors.black.withOpacity(.06), blurRadius: 18.r, offset: Offset(0, 10.h)),
    ],
