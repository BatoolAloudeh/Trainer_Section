    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Padding(padding: EdgeInsets.all(20.w), child: _buildLoginForm()),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          defaultFormField(
            ...
            validate: (value) {
              if (value == null || value.isEmpty) {
                return AppLocalizations.of(context)?.translate("No Email") ??
                    "No Email";
              } else if (!RegExp(
          ...
          defaultFormField(
            ...
            validate: (value) {
              if (value == null || value.isEmpty) {
                return AppLocalizations.of(context)?.translate("No password") ??
                    "No password";
                    ...
                    if (state is LoginNotVerified) ...[
                      ...
                      Row(
                        children: [
                          ...
                          TextButton(
                            onPressed: () {
                              context.push(RoutePaths.checkCode);
                            },
                            child: Text(
                              AppLocalizations.of(
                                    context,
